...
public class RadarUI : MonoBehaviour
{
    ...
    void Update()
    {
        transform.rotation = Quaternion.Euler(0, 0, -Player.transform.rotation.eulerAngles.y);
        PlayerVision.transform.rotation = Quaternion.Euler(0, 0, -mc.transform.rotation.eulerAngles.y);
